    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="flex justify-center">
                <div className="m-2">
                    <a
                        href="https://github.com/kodcanlisi/compress-img"
                        target="_blank"
		...
		C438.536,184.851,428.728,148.168,409.132,114.573z" />
                ...
                <div className="m-2">
                    <a
                        href="https://github.com/kodcanlisi/compress-img-web/"
                        target="_blank"
                        class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"
                    >
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0" y="0"
		...
		C438.536,184.851,428.728,148.168,409.132,114.573z" />
            ...
            <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
                <div>
                    <BasicCard
                        title="1. Başlangıç Ekip Tanışması"
                ...
                <div>
                    <BasicCard
                        title="2. Aws'den Vazgeçtik!"
                        content="Aws'den vazgeçme nedenimiz ve ilk GIF testi"
                        videoId="_DrVb_7fdF4"
                    />
                </div>
                ...
                <div>
                    <BasicCard
                        title="3. Sitemizin Avantajları"
                        content="İnsanlar neden bizi tercih etmeli? Neden bu ürünü almalı?"
                        videoId="YjdGOBO2G2k"
                    />
                </div>
                <div>
                    <BasicCard
                        title="4. Hakkımızda Sayfamız"
                        content="Hakkımızda sayfamız üzerine planlarımız ve SVG testi"
                        videoId="Ri-_Nltok4U"
                    />
                </div>
